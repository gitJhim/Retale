...
public class ConfirmNeighborhoodCreation extends Menu {
    Retale retale;
    private String newNeighborhoodName;

    public ConfirmNeighborhoodCreation(Retale retale, PlayerMenuUtility playerMenuUtility) {
        super(playerMenuUtility);
        newNeighborhoodName = playerMenuUtility.getCreateNeighborhoodName();
        this.retale = retale;
    }

    @Override
    public String getMenuName() {
        return "&aConfirm Neighborhood Name";
    }
    ...
    public void handleMenu(InventoryClickEvent e) {
        ...
        switch(e.getCurrentItem().getType()) {
            case GREEN_TERRACOTTA:
                p.closeInventory();
                p.sendMessage(retale.formatInfo("&7Creating &a&l" + newNeighborhoodName + "&r&7..."));
                retale.getNeighborhoodManager().createNeighborhood(newNeighborhoodName);
                break;
            case RED_TERRACOTTA:
                p.closeInventory();
    ...
    public void setMenuItems() {
        ...
        inventory.setItem(4, retale.basicItem(Material.OAK_SIGN, "&7Create neighborhood named &a&l" + newNeighborhoodName + "&r&7?"));
